...
- (NSMutableArray *)shareArray{
    if (!_shareArray) {
        ...
        [_shareArray addObject:CusTomPlatformNameForWordCommuity];
        [_shareArray addObject:[[IFMShareItem alloc] initWithImage:[UIImage imageNamed:@"function_link"] title:@"复制链接" action:^(IFMShareItem *item) {
