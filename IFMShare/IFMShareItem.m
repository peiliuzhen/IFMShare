...
NSString *const  CusTomPlatformNameForWordCommuity = @"CusTomPlatformNameForWordCommuity";
...
NSString *const  CusTomPlatformHandleForWordCommuity = @"CusTomPlatformHandleForWordCommuity";
...
/******************************各种平台***********************************************/
    ...
    if ([platformName isEqualToString:CusTomPlatformNameForWordCommuity]) {
        messageDict = @{@"image":@"share_alipay",@"title":@"圈子",@"action":CusTomPlatformHandleForWordCommuity};
    }
